...
@Component({
  selector: 'app-obrasterminadas',
  templateUrl: './obrasterminadas.page.html',
  styleUrls: ['./obrasterminadas.page.scss'],
})
export class ObrasterminadasPage implements OnInit {
  array:Observable<any>;
  constructor(private departamento:DepartamentosService, private browser:InAppBrowser) { }

  ngOnInit() {
    this.array=this.departamento.obrasTerminadas();
  }
